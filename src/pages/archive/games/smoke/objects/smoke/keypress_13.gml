// [DnD action] fn_name=action_if_variable lib_id=1 action_kind=0 exec_type=1 is_condition=true applies_to=-1 invert=false relative=false params=["start", "false", "0"] param_types=[0, 0, 4]
...
start
start
// [DnD action] fn_name=action_set_score lib_id=1 action_kind=0 exec_type=1 is_condition=false applies_to=-1 invert=false relative=false params=["0"] param_types=[0]
